/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: 6aad8ac2cbd82a4e2fa743fdb10736f3)
// Runtime types generated with workerd@1.20260708.1 2026-07-12 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	OAUTH_KV: KVNamespace;
	DB: D1Database;
	CHAIN_ID: "1";
	CANONICAL_MCP_URI: "https://swap-mcp.simon-tanna.workers.dev";
	TRADING_API_BASE_URL: "https://trade-api.gateway.uniswap.org/v1";
	ALLOWED_ORIGINS: "https://claude.ai,https://swap-mcp.simon-tanna.workers.dev";
	SWAP_PRIVATE_KEY: string;
	AUTH_PASSPHRASE: string;
	UNISWAP_API_KEY: string;
	ETH_RPC_URL: string;
	SWAP_COORDINATOR: DurableObjectNamespace<import("./src/index").SwapCoordinator>;
	SwapMcpAgent: DurableObjectNamespace<import("./src/index").SwapMcpAgent>;
	RATE_LIMITER: DurableObjectNamespace<import("./src/index").RateLimiter>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "SwapCoordinator" | "SwapMcpAgent" | "RateLimiter";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CHAIN_ID" | "CANONICAL_MCP_URI" | "TRADING_API_BASE_URL" | "ALLOWED_ORIGINS" | "SWAP_PRIVATE_KEY" | "AUTH_PASSPHRASE" | "UNISWAP_API_KEY" | "ETH_RPC_URL">> {}
}
